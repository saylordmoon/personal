...
b.format;f.extend(b,l);m.on("mousedown",function(){e()});b.onClick=function(b){a.prop("value",b);d=b;e()};var p=function(){w=parseInt(a.offset().left);y=parseInt(a.offset().top);g=parseInt(a.outerWidth(!0));c.css("left",w+"px").css("top",y+35+"px");(h=a.prop("value"))&&h!==d&&0>b.format.indexOf("L")&&(k=moment(h,b.format),k.isValid()&&c.ionCalendar("update",{startDate:h}))};(function(){v='<div class="ic__datepicker" id="ic__datepicker-'+A.pluginCount+'"></div>';m.append(v);c=f("#ic__datepicker-"+
